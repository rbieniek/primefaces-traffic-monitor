 ...
 *
 */
public class Snmp4jTestAgent extends BaseAgent {

	private InetSocketAddress socketAddr;
	
	public Snmp4jTestAgent(int portNumber) {
		super(new File("target/conf.agent"), new File("target/bootCounter.agent"),
				new CommandProcessor(
						new OctetString(MPv3.createLocalEngineID())));
		
		socketAddr = new InetSocketAddress(InetAddress.getLoopbackAddress(), portNumber);
	}
	...
	protected void initTransportMappings() throws IOException {
		...
		transportMappings[0] = TransportMappings.getInstance()
				.createTransportMapping(new UdpAddress(socketAddr.getAddress(), socketAddr.getPort()));
	}
